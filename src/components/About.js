  ...
  return( 
    <section className="flex lg:flex-row gap-3 justify-center m-9 lg:m-24 flex-col" id="about">
      <div className="flex lg:flex-col lg:w-1/2 gap-3 text-white">
        <div className='bg-saltBox w-fully h-fit rounded-lg p-6 lg:p-10 shadow-ls'>
        ...
        <div className='hidden lg:flex relative'>
          ...
          <p className={classNames("p-6 top-1/2 rounded-lg",{"visible text-black bg-white absolute opacity-100 transition-all duration-600 left-7rm" : isClicked}, {"invisible opacity-0" : !isClicked})}>
            PD: Me gustan mucho los gatitos y leer. 
          </p>
        </div>
      </div>

      <div className='bg-saltBox lg:w-1/2 h-fit text-white rounded-lg p-6 lg:p-10 lg:pt-20 shadow-ls'>
        ...
        <div className='mt-6'>
          <a 
              className="font-body font-bold p-4 bg-citrineWhite rounded-xl text-black hover:bg-perfume transition-all flex flex-row gap-2 w-fit"
